...
import task_7.services.StudentService;
import task_7.services.SubjectService;
import task_7.services.TeacherService;
...
@Configuration
@ComponentScan(basePackages = "task_7")
@EnableJpaRepositories(basePackages = "task_7")
